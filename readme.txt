...
Author: Kristian Funkel (nicknamed Meow @ Github)
Contact: pixelshader@hotmail.com

~ About ~
This is a Memory game developed in C#.
...
To build this in Linux
mdtool build -f:WinMemory.sln